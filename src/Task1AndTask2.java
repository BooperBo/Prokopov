...
//        log10 - десятичный логарифм
        ...
        b1 = Math.pow(100, 0.5 * Math.log(9) - Math.log10(2)) * (Math.tan(0.52));

        System.out.printf("Значение a = %f\n", a1); // %f - это число с плавающей точкой. Чтобы округлить число
        // или вывыести к примеру 2 знака после запятной, нужно добавить .2 перед f. будет выглядеть так %.2f
